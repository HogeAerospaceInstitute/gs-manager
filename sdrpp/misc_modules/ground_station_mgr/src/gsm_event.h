...
typedef enum GsmFSMEventId
{
	...
	GSM_FSM_EVENT_ID_DEACTIVATE_TASK,
	GSM_FSM_EVENT_ID_TRACKING_RSP,
	GSM_FSM_EVENT_ID_TRACKING_TIMEOUT,
	GSM_FSM_EVENT_ID_GET_POS_RSP,
	GMS_FSM_EVENT_ID_GET_POS_TIMEOUT,
	GSM_FSM_EVENT_ID_RELOAD_DB_RSP,
	GSM_FSM_EVENT_ID_RELOAD_DB_TIMEOUT,
	GSM_FSM_EVENT_ID_MOVE_ROTATOR_RSP,
	GSM_FSM_EVENT_ID_MOVE_ROTATOR_TIMEOUT,
	GSM_FSM_EVENT_ID_GET_ROTATOR_POS_RSP,
	GSM_FSM_EVENT_ID_GET_ROTATOR_POS_TIMEOUT,
	GSM_FSM_EVENT_ID_CHECK_ROTATOR_DELAY_TIMEOUT,
	GSM_FSM_EVENT_ID_RECORDING_DELAY_TIMEOUT,

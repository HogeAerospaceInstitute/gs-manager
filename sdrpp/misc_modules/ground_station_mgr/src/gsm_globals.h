...
#define GSM_MSG_TYPE_GET_GROUND_STATION_INFO_REQ	GSM_MSG_CAT_GSMGR+0x0010
#define GSM_MSG_TYPE_GET_GROUND_STATION_INFO_RSP	GSM_MSG_CAT_GSMGR+0x0011
#define GSM_MSG_TYPE_UPLOAD_RECORDINGS_REQ			GSM_MSG_CAT_GSMGR+0x0012

...
#define GSM_MSG_TYPE_TRACK_SATELLITE_REQ	GSM_MSG_CAT_GSMGR+0x0003
#define GSM_MSG_TYPE_TRACK_SATELLITE_RSP	GSM_MSG_CAT_GSMGR+0x0004
#define GSM_MSG_TYPE_DEACTIVATE_TASK_REQ    GSM_MSG_CAT_GSMGR+0x0005
#define GSM_MSG_TYPE_REFRESH_TASKS_REQ		GSM_MSG_CAT_GSMGR+0x0006
#define GSM_MSG_TYPE_REFRESH_TASKS_RSP		GSM_MSG_CAT_GSMGR+0x0007
#define GSM_MSG_TYPE_CLEAR_TASKS_REQ		GSM_MSG_CAT_GSMGR+0x0008
#define GSM_MSG_TYPE_ACTIVATE_TASK_REQ		GSM_MSG_CAT_GSMGR+0x0009
...
#define GSM_MSG_TYPE_MOVE_ROTATOR_REQ		GSM_MSG_CAT_ROTCTRL+0x0003
#define GSM_MSG_TYPE_MOVE_ROTATOR_RSP		GSM_MSG_CAT_ROTCTRL+0x0004
#define GSM_MSG_TYPE_QUERY_ROTATOR_POS_REQ	GSM_MSG_CAT_ROTCTRL+0x0005
#define GSM_MSG_TYPE_QUERY_ROTATOR_POS_RSP	GSM_MSG_CAT_ROTCTRL+0x0006
